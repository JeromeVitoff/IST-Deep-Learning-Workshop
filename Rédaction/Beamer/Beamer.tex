...
\item Préservation du patrimoine numérique (linguistique)
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item Dropout progressif (0.25/0.5)
                \item Padding 'same'
            \end{itemize}
            ...
            \begin{itemize}
                ...
                \item \textbf{Dropout progressif :} Anti-surapprentissage
...
\begin{frame}{Conclusion}
    ...
    \begin{itemize}
        \item \emphasize{Progression spectaculaire :} 54.6\% → 98.5\%
