...
\institute[Paul Valéry]{
    Master MIASHS, Université Paul Valéry, Montpellier III
}
\date{Juin 2025}
...
\begin{frame}[plain]
    ...
    \begin{center}
        \begin{tcolorbox}[colback=univ_blue, colframe=univ_blue, arc=4mm, boxrule=0pt, width=0.9\textwidth, enhanced]
            {\color{white}\centering\Large \textbf{Reconnaissance de Caractères Ourdou avec Deep Learning}}
        \end{tcolorbox}
        ...
        \footnotesize Tuteur : M. Jérôme Pasquet
    \end{center}
\end{frame}
